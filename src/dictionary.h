...
class Dictionary {
 ...
 public:
  ...
  void readFromFileTree(std::istream&);
  ...
  int32_t getLine(std::istream&, std::vector<int32_t>&, std::vector<int32_t>&)
      const;
  int32_t getLine(std::istream&, std::vector<int32_t>&, std::minstd_rand&, std::ifstream& pos)
      const;
  int32_t getLineMine(std::istream&, std::unordered_map<std::string, std::vector<std::string>>&, std::minstd_rand&, std::ifstream& pos) const;
