...
//    }
//
//    Dictionary::Dictionary(std::shared_ptr<fasttext::Args> args)
//    :args_(args),
//     word2int_(MAX_VOCAB_SIZE, -1),
//     size_(0),
//     nwords_(0),
...
//        sort(words_.begin(), words_.end(), [](entry &e1, entry & e2) {
//            if (e1.type != e2.type) {
...
//                    ngram.push_back(word[j++]);
//                }
//                if (n >= args_->minn && !(n == 1 && (i == 0 || j == words_.size()))) {
